...
class resnet_v1_101_rcnn_dcn(Symbol):
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        rpn_cls_score_p5, rpn_bbox_pred_p5 = self.get_rpn(p5, num_anchors_p5,'/p5')
        ...
        if is_train:
            ...
            # ROI proposal target
            rois = mx.symbol.Concat(rois_p3,rois_p4,rois_p5,dim=0,name='concat_rois')
            score = mx.symbol.Concat(score_p3,score_p4,score_p5,dim=0,name='concat_score')
            rois = mx.symbol.Custom(rois = rois ,score = score,op_type='assign_rois') 
            rois = mx.symbol.SliceChannel(data=rois, axis=0, num_outputs=3, name='slice_rois') 
            gt_boxes_reshape = mx.sym.Reshape(data=gt_boxes, shape=(-1, 5), name='gt_boxes_reshape')
            
            rois_p3, label_p3, bbox_target_p3, bbox_weight_p3 = mx.sym.Custom(rois=rois[0], gt_boxes=gt_boxes_reshape,
            ...
            rois_p4, label_p4, bbox_target_p4, bbox_weight_p4 = mx.sym.Custom(rois=rois[1], gt_boxes=gt_boxes_reshape,
                                                                  op_type='proposal_target',
                                                                  num_classes=num_reg_classes,
                                                                  batch_images=cfg.TRAIN.BATCH_IMAGES,
                                                                  batch_rois=cfg.TRAIN.BATCH_ROIS,
            ...
            rois_p5, label_p5, bbox_target_p5, bbox_weight_p5 = mx.sym.Custom(rois=rois[2], gt_boxes=gt_boxes_reshape,
                                                                   op_type='proposal_target',
                                                                   num_classes=num_reg_classes,
                                                                   batch_images=cfg.TRAIN.BATCH_IMAGES,
                                                                   batch_rois=cfg.TRAIN.BATCH_ROIS,   
...
####################################################
    ...
    #        label = mx.sym.Concat(label_p3,label_p4,label_p5,dim =0)
     #       bbox_target = mx.sym.Concat(bbox_target_p3,bbox_target_p4,bbox_target_p5,dim=0)
      #      bbox_weight = mx.sym.Concat(bbox_weight_p3,bbox_weight_p4,bbox_weight_p5,dim=0)
            ...
            rois = mx.sym.Concat(rois_p3,rois_p4,rois_p5,dim=0,name = 'rois')
        ...
        offset_t_p5 = mx.contrib.sym.DeformablePSROIPooling(name='offset_t/p5', data=p5, rois=rois_p5, group_size=1, pooled_size=7,
        ...
        deformable_roi_pool_p5 = mx.contrib.sym.DeformablePSROIPooling(name='deformable_roi_pool/p5', data=p5, rois=rois_p5,
        ...
        #######################concat all rois#####################################################
     #   deformable_roi_pool = mx.sym.Concat(deformable_roi_pool_p3,deformable_roi_pool_p4,deformable_roi_pool_p5,dim =0,name='deformable_roi_pool')
    ...
    #         group = mx.sym.Group([rpn_cls_prob_p3,rpn_bbox_loss_p3,rpn_cls_prob_p4, rpn_bbox_loss_p4, rpn_cls_prob_p5,rpn_bbox_loss_p5, cls_prob,bbox_loss, mx.sym.BlockGrad(rcnn_label)])

    #         # group = mx.sym.Group([rpn_cls_prob_p3,rpn_bbox_loss_p3,rpn_cls_prob_p4, rpn_bbox_loss_p4, rpn_cls_prob_p5,rpn_bbox_loss_p5,
    #         #                      cls_prob_p3, bbox_loss_p3, mx.sym.BlockGrad(rcnn_label_p3),
    #         #                       cls_prob_p4, bbox_loss_p4, mx.sym.BlockGrad(rcnn_label_p4),
    #         #                        cls_prob_p5, bbox_loss_p5, mx.sym.BlockGrad(rcnn_label_p5)])
    #     else:
...
#######################################
        ####rcnn/p3
        # 2 fc
        fc_new_1_p3 = mx.sym.FullyConnected(name='fc_new_1/p3', data=deformable_roi_pool_p3, num_hidden=1024)
        fc_new_1_relu_p3 = mx.sym.Activation(data=fc_new_1_p3, act_type='relu', name='fc_new_1_relu/p3')
        fc_new_1_d_p3 = mx.symbol.Dropout(data=fc_new_1_relu_p3, p=0.5, name="drop_1/p3")

        fc_new_2_p3 = mx.sym.FullyConnected(name='fc_new_2/p3', data=fc_new_1_d_p3, num_hidden=1024)
        fc_new_2_relu_p3 = mx.sym.Activation(data=fc_new_2_p3, act_type='relu', name='fc_new_2_relu/p3')
        fc_new_2_d_p3 = mx.symbol.Dropout(data=fc_new_2_relu_p3, p=0.5, name="drop_2/p3")
        # cls_score/bbox_pred
        cls_score_p3 = mx.sym.FullyConnected(name='cls_score/p3', data=fc_new_2_d_p3, num_hidden=num_classes)
        bbox_pred_p3 = mx.sym.FullyConnected(name='bbox_pred/p3',data=fc_new_2_relu_p3, num_hidden=num_reg_classes * 4)

#######################################
        ####rcnn/p4
        # 2 fc
        fc_new_1_p4 = mx.sym.FullyConnected(name='fc_new_1/p4',data=deformable_roi_pool_p4, num_hidden=1024)
        fc_new_1_relu_p4 = mx.sym.Activation(data=fc_new_1_p4, act_type='relu', name='fc_new_1_relu/p4')

        fc_new_1_d_p4 = mx.symbol.Dropout(data=fc_new_1_relu_p4, p=0.5, name="drop_1/p4")

        fc_new_2_p4 = mx.sym.FullyConnected(name='fc_new_2/p4', data=fc_new_1_relu_p4, num_hidden=1024)
        fc_new_2_relu_p4 = mx.sym.Activation(data=fc_new_2_p4, act_type='relu', name='fc_new_2_relu/p4')
 
        fc_new_2_d_p4 = mx.symbol.Dropout(data=fc_new_2_relu_p4, p=0.5, name="drop_2/p4")

        # cls_score/bbox_pred
        cls_score_p4 = mx.sym.FullyConnected(name='cls_score/p4', data=fc_new_2_d_p4, num_hidden=num_classes)
        bbox_pred_p4 = mx.sym.FullyConnected(name='bbox_pred/p4',data=fc_new_2_relu_p4, num_hidden=num_reg_classes * 4)

#######################################
        ####rcnn/p5
        # 2 fc
        fc_new_1_p5 = mx.sym.FullyConnected(name='fc_new_1/p5', data=deformable_roi_pool_p5, num_hidden=1024)
        fc_new_1_relu_p5 = mx.sym.Activation(data=fc_new_1_p5, act_type='relu', name='fc_new_1_relu/p5')
        fc_new_1_d_p5 = mx.symbol.Dropout(data=fc_new_1_relu_p5, p=0.5, name="drop_1/p5")

        fc_new_2_p5 = mx.sym.FullyConnected(name='fc_new_2/p5', data=fc_new_1_relu_p5, num_hidden=1024)
        fc_new_2_relu_p5 = mx.sym.Activation(data=fc_new_2_p5, act_type='relu', name='fc_new_2_relu/p5')
        fc_new_2_d_p5 = mx.symbol.Dropout(data=fc_new_2_relu_p5, p=0.5, name="drop_2/p5")
        # cls_score/bbox_pred
        cls_score_p5 = mx.sym.FullyConnected(name='cls_score/p5', data=fc_new_2_d_p5, num_hidden=num_classes)
        bbox_pred_p5 = mx.sym.FullyConnected(name='bbox_pred/p5', data=fc_new_2_relu_p5, num_hidden=num_reg_classes * 4)
...
#######################################
        ...
        if is_train:
            if cfg.TRAIN.ENABLE_OHEM:
                ######p3
                labels_ohem_p3, bbox_weights_ohem_p3 = mx.sym.Custom(op_type='BoxAnnotatorOHEM', num_classes=num_classes,
                                                               num_reg_classes=num_reg_classes,
                                                               roi_per_img=cfg.TRAIN.BATCH_ROIS_OHEM,
                                                               cls_score=cls_score_p3, bbox_pred=bbox_pred_p3, labels=label_p3,
                                                               bbox_targets=bbox_target_p3, bbox_weights=bbox_weight_p3)
                cls_prob_p3 = mx.sym.SoftmaxOutput(name='cls_prob/p3', data=cls_score_p3, label=labels_ohem_p3,
                                                normalization='valid', use_ignore=True, ignore_label=-1)
                p3_bbox_loss_ = bbox_weights_ohem_p3 * mx.sym.smooth_l1(name='bbox_loss_/p3', scalar=1.0,
                                                                  data=(bbox_pred_p3 - bbox_target_p3))
                bbox_loss_p3 = mx.sym.MakeLoss(name='bbox_loss', data=p3_bbox_loss_,
                                            grad_scale=1.0 / cfg.TRAIN.BATCH_ROIS_OHEM)
                rcnn_label_p3 = labels_ohem_p3
                ####p4
            
                labels_ohem_p4, bbox_weights_ohem_p4 = mx.sym.Custom(op_type='BoxAnnotatorOHEM', num_classes=num_classes,
                                                               num_reg_classes=num_reg_classes,
                                                               roi_per_img=cfg.TRAIN.BATCH_ROIS_OHEM,
                                                               cls_score=cls_score_p4, bbox_pred=bbox_pred_p4, labels=label_p4,
                                                               bbox_targets=bbox_target_p4, bbox_weights=bbox_weight_p4)
                cls_prob_p4 = mx.sym.SoftmaxOutput(name='cls_prob/p4', data=cls_score_p4, label=labels_ohem_p4,
                                                normalization='valid', use_ignore=True, ignore_label=-1)
                p4_bbox_loss_ = bbox_weights_ohem_p4 * mx.sym.smooth_l1(name='bbox_loss_/p4', scalar=1.0,
                                                                  data=(bbox_pred_p4 - bbox_target_p4))
                bbox_loss_p4 = mx.sym.MakeLoss(name='bbox_loss', data=p4_bbox_loss_,
                                            grad_scale=1.0 / cfg.TRAIN.BATCH_ROIS_OHEM)
                rcnn_label_p4 = labels_ohem_p4
                ####p5
                labels_ohem_p5, bbox_weights_ohem_p5 = mx.sym.Custom(op_type='BoxAnnotatorOHEM', num_classes=num_classes,
                                                               num_reg_classes=num_reg_classes,
                                                               roi_per_img=cfg.TRAIN.BATCH_ROIS_OHEM,
                                                               cls_score=cls_score_p5, bbox_pred=bbox_pred_p5, labels=label_p5,
                                                               bbox_targets=bbox_target_p5, bbox_weights=bbox_weight_p5)
                cls_prob_p5 = mx.sym.SoftmaxOutput(name='cls_prob/p5', data=cls_score_p5, label=labels_ohem_p5,
                                                normalization='valid', use_ignore=True, ignore_label=-1)
                p5_bbox_loss_ = bbox_weights_ohem_p5 * mx.sym.smooth_l1(name='bbox_loss_/p5', scalar=1.0,
                                                                  data=(bbox_pred_p5 - bbox_target_p5))
                bbox_loss_p5 = mx.sym.MakeLoss(name='bbox_loss', data=p5_bbox_loss_,
                                            grad_scale=1.0 / cfg.TRAIN.BATCH_ROIS_OHEM)
                rcnn_label_p5 = labels_ohem_p5


            else:
                ##p3
                cls_prob_p3 = mx.sym.Custom(op_type='FocalLoss', name = 'cls_prob/p3', data = cls_score_p3, labels = label_p3, alpha =0.25, gamma= 2)
               # cls_prob_p3 = mx.sym.SoftmaxOutput(name='cls_prob/p3', data=cls_score_p3, label=label_p3, normalization='valid')
                p3_bbox_loss_ = bbox_weight_p3 * mx.sym.smooth_l1(name='bbox_loss_/p3', scalar=1.0,
                                                            data=(bbox_pred_p3 - bbox_target_p3))
                bbox_loss_p3 = mx.sym.MakeLoss(name='bbox_loss/p3', data=p3_bbox_loss_, grad_scale=1.0 / cfg.TRAIN.BATCH_ROIS)
                rcnn_label_p3 = label_p3
                ##p4
                cls_prob_p4 = mx.sym.Custom(op_type='FocalLoss', name = 'cls_prob/p4', data = cls_score_p4, labels = label_p4, alpha =0.25, gamma= 2)

                #cls_prob_p4 = mx.sym.SoftmaxOutput(name='cls_prob/p4', data=cls_score_p4, label=label_p4, normalization='valid')

                p4_bbox_loss_ = bbox_weight_p4 * mx.sym.smooth_l1(name='bbox_loss_/p4', scalar=1.0,
                                                            data=(bbox_pred_p4 - bbox_target_p4))
                bbox_loss_p4 = mx.sym.MakeLoss(name='bbox_loss/p4', data=p4_bbox_loss_, grad_scale=1.0 / cfg.TRAIN.BATCH_ROIS)
                rcnn_label_p4 = label_p4
                ##
                cls_prob_p5 = mx.sym.Custom(op_type='FocalLoss', name = 'cls_prob/p5', data = cls_score_p5, labels = label_p5, alpha =0.25, gamma= 2)

              #  cls_prob_p5 = mx.sym.SoftmaxOutput(name='cls_prob/p5', data=cls_score_p5, label=label_p5, normalization='valid')
                p5_bbox_loss_ = bbox_weight_p5 * mx.sym.smooth_l1(name='bbox_loss/p5', scalar=1.0,
                                                            data=(bbox_pred_p5 - bbox_target_p5))
                bbox_loss_p5 = mx.sym.MakeLoss(name='bbox_loss', data=p5_bbox_loss_, grad_scale=1.0 / cfg.TRAIN.BATCH_ROIS)
                rcnn_label_p5 = label_p5
            # reshape output
            #####p3
            rcnn_label_p3 = mx.sym.Reshape(data=rcnn_label_p3, shape=(cfg.TRAIN.BATCH_IMAGES, -1), name='label_reshape')
            cls_prob_p3 = mx.sym.Reshape(data=cls_prob_p3, shape=(cfg.TRAIN.BATCH_IMAGES, -1, num_classes),
                                      name='cls_prob_reshape/p3')
            bbox_loss_p3 = mx.sym.Reshape(data=bbox_loss_p3, shape=(cfg.TRAIN.BATCH_IMAGES, -1, 4 * num_reg_classes),
                                       name='bbox_loss_reshape/p3')
            ######p4

            rcnn_label_p4 = mx.sym.Reshape(data=rcnn_label_p4, shape=(cfg.TRAIN.BATCH_IMAGES, -1), name='label_reshape/p4')
            cls_prob_p4 = mx.sym.Reshape(data=cls_prob_p4, shape=(cfg.TRAIN.BATCH_IMAGES, -1, num_classes),
                                      name='cls_prob_reshape/p4')
            bbox_loss_p4 = mx.sym.Reshape(data=bbox_loss_p4, shape=(cfg.TRAIN.BATCH_IMAGES, -1, 4 * num_reg_classes),
                                       name='bbox_loss_reshape/p4')
            ######p5

            rcnn_label_p5 = mx.sym.Reshape(data=rcnn_label_p5, shape=(cfg.TRAIN.BATCH_IMAGES, -1), name='label_reshape/p5')
            cls_prob_p5 = mx.sym.Reshape(data=cls_prob_p5, shape=(cfg.TRAIN.BATCH_IMAGES, -1, num_classes),
                                      name='cls_prob_reshape/p5')
            bbox_loss_p5 = mx.sym.Reshape(data=bbox_loss_p5, shape=(cfg.TRAIN.BATCH_IMAGES, -1, 4 * num_reg_classes),
                                       name='bbox_loss_reshape/p5')   
            ...
            ##p3
            cls_prob_p3 = mx.sym.SoftmaxActivation(name='cls_prob/p3', data=cls_score_p3)
            cls_prob_p3 = mx.sym.Reshape(data=cls_prob_p3, shape=(cfg.TEST.BATCH_IMAGES, -1, num_classes),
                                      name='cls_prob_reshape/p3')
            bbox_pred_p3 = mx.sym.Reshape(data=bbox_pred_p3, shape=(cfg.TEST.BATCH_IMAGES, -1, 4 * num_reg_classes),
                                       name='bbox_pred_reshape/p3')
            ##p4
            cls_prob_p4 = mx.sym.SoftmaxActivation(name='cls_prob/p4', data=cls_score_p4)
            cls_prob_p4 = mx.sym.Reshape(data=cls_prob_p4, shape=(cfg.TEST.BATCH_IMAGES, -1, num_classes),
                                      name='cls_prob_reshape/p4')
            bbox_pred_p4 = mx.sym.Reshape(data=bbox_pred_p4, shape=(cfg.TEST.BATCH_IMAGES, -1, 4 * num_reg_classes),
                                       name='bbox_pred_reshape/p4')
            ##p5
            cls_prob_p5 = mx.sym.SoftmaxActivation(name='cls_prob/p5', data=cls_score_p5)
            cls_prob_p5 = mx.sym.Reshape(data=cls_prob_p5, shape=(cfg.TEST.BATCH_IMAGES, -1, num_classes),
                                      name='cls_prob_reshape/p5')
            bbox_pred_p5 = mx.sym.Reshape(data=bbox_pred_p5, shape=(cfg.TEST.BATCH_IMAGES, -1, 4 * num_reg_classes),
                                       name='bbox_pred_reshape/p5')

            cls_prob = mx.sym.Concat(cls_prob_p3,cls_prob_p4,cls_prob_p5,dim=0,name = 'cls_pro')
            bbox_pred = mx.sym.Concat(bbox_pred_p3,bbox_pred_p4,bbox_pred_p5,dim=0,name = 'bbox_pred_reshape')
